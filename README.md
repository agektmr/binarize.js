...
## Why not Protocol Buffers nor msgpack?
As they are widely used and have wider adoption in terms of implementation, I consider binarize.js is just a temporary solution and recommend to use Protocol Buffers or msgpack in stead. The reasons I did this are  

* Any of current JS implementation of Protocol Buffers and msgpack don’t support TypedArray inside object.
